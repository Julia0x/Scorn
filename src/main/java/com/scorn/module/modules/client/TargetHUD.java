...
import com.scorn.utils.font.fonts.FontRenderer;
import com.scorn.utils.render.DrawUtils;
import com.scorn.utils.render.ThemeUtils;
import com.scorn.utils.render.animations.MutableAnimation;
import com.scorn.utils.render.shaders.ShaderUtils;
...
public class TargetHUD extends Module {
    public static final ModeSetting targethudmode = new ModeSetting("TargetHUD Mode", "Scorn", "Scorn", "Adjust", "Novo");
    ...
    public final Listener<EventRender2D> eventRender2DListener = event -> {
        ...
        switch (targethudmode.getMode()) {
            case "Scorn" -> drawScornTargetHud(event);
    ...
    private void drawScornTargetHud(EventRender2D event) {
        int height = event.getHeight();
        int width = event.getWidth();
