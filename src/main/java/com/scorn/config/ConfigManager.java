...
public class ConfigManager {
    ...
    @Getter
    private final File configDir = new File(MinecraftClient.getInstance().runDirectory, "Scorn" + File.separator + "configs");
    ...
    public void loadCloudConfig(String configName) {
        final String urlString = "https://raw.githubusercontent.com/StephenIsTaken/Scorn-CloudAPI/main/configs/" + configName + ".json";
    ...
    public String getCloudConfigList() {
        try {
            URL url = new URL("https://raw.githubusercontent.com/StephenIsTaken/Scorn-CloudAPI/main/configs/configs.txt");
            HttpURLConnection connection = (HttpURLConnection) url.openConnection();
            connection.setRequestMethod("GET");
